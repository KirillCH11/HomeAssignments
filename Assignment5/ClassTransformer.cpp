...
void Transformer::transform() {
    std::cout << "Transform method called from Transformer class" << std::endl;
}

void Transformer::openFire() {
    std::cout << "OpenFire method called from Transformer class" << std::endl;
}

void Transformer::ulta() {
    std::cout << "Ulta method called from Transformer class" << std::endl;
}
